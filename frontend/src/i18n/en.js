...
export default {
  ...
  une: "combines",
  "tomado de Alzola, con": "taken from Alzola, with",
  "laboratorio. La sílaba": "laboratory. The syllable",
  "actúa como bisagra visual: completa el apellido Alzo·la y, al mismo tiempo, abre la palabra “lab”. El nombre convierte una firma personal en la idea central del programa: un laboratorio donde experimentar con corpus.":
    "acts as a visual hinge: it completes the surname Alzo·la and at the same time opens the word “lab”. The name turns a personal signature into the program's core idea: a laboratory for experimenting with corpora.",
};
