...
export default {
  ...
  Deshacer: "Undo",
  Rehacer: "Redo",
  "Selecciona al menos un documento.": "Select at least one document.",
  "{m} de {n} para analizar": "{m} of {n} for analysis",
  Todos: "All",
  Ninguno: "None",
  "Incluir en el análisis": "Include in the analysis",
  ...
  "Escribe una regla para ver en vivo lo que se elimina. El corpus no se modifica hasta que pulses «Aplicar».":
    "Type a rule to see live what gets removed. The corpus is not modified until you click “Apply”.",
